...
rm -f ~/.local/share/nautilus-python/extensions/CursorExtension.py
rm -f ~/.local/share/nautilus-python/extensions/cursor-nautilus.py

# Download and install the extension
echo "Downloading newest version..."
wget -q -O ~/.local/share/nautilus-python/extensions/cursor-nautilus.py https://raw.githubusercontent.com/taeraemon/cursor-nautilus/master/cursor-nautilus.py
